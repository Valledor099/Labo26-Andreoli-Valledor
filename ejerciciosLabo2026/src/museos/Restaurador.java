...
public class Restaurador extends Persona {
    ...
    public Restaurador(String nombre, String apellido, String dni, LocalDate fechaNacimiento, int aniosExperiencia) {
    ...
    public String toString() {
        return super.getNombre() + " " + super.getApellido() + " (DNI: " + dni + ") - Experiencia: " + aniosExperiencia + " años";
    }
